...
% Colours
\usepackage{xcolor}
\definecolor{Left}{RGB}{49,102,158}
\definecolor{LeanLeft}{RGB}{159,201,235}
...
\bibliography{bibliography/thesis,bibliography/entropy_rate,bibliography/Data}
\end{document}
